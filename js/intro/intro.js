...
function renderIntro() {
	...
	function render() {
		...
		sphereMesh.position.x = 50*Math.cos(camera.getWorldRotation().z)+0*Math.sin(camera.getWorldRotation().z);
		sphereMesh.position.z = -50*Math.sin(camera.getWorldRotation().z)+0*Math.cos(camera.getWorldRotation().z);
		hjk+=0.01;
